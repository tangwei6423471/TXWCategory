...
{
    return [[self toGMTDate] dateComponentsBylocaleIdentifier:NSGregorianCalendar];
}
...
- (NSDate *)getDate
{
    ...
    NSDate *submitDate = [NSDate ToNSDate:[NSString stringWithFormat:@"%d-%d-%d",dc.year,dc.month,dc.day] format:@"yyyy-MM-dd"];
